...
export default {
    ...
    methods: {
        loadAllResources() {
            ...
            axios.get($this.route('codicastudio.health.resources.all')).then(function(response) {
        ...
        checkResource(resource) {
            ...
            axios
                .get(this.route('codicastudio.health.resources.get', {slug: resource.slug}) + '?flush=1')
