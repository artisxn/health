...
namespace codicastudio\Health;

use Event;
use codicastudio\Yaml\Package\Yaml;
use codicastudio\Health\Support\Cache;
use Illuminate\Console\Scheduling\Schedule;
use codicastudio\Health\Support\ResourceLoader;
use codicastudio\Health\Support\Traits\Routing;
use codicastudio\Health\Events\RaiseHealthIssue;
use codicastudio\Health\Support\ResourceChecker;
use codicastudio\Health\Listeners\NotifyHealthIssue;
use codicastudio\Health\Console\Commands as ConsoleCommands;
...
class ServiceProvider extends IlluminateServiceProvider
{
        ...
        $this->publishes(
            [
                __DIR__.'/resources/views/' => resource_path(
                    'views/vendor/codicastudio/health/'
                ),
            ],
            'views'
        );
    ...
    private function registerServices()
    {
        ...
        $this->app->singleton('codicastudio.health.cache', $this->cacheClosure);

        $this->app->singleton(
            'codicastudio.health.resource.checker',
            $this->resourceCheckerClosure
        );

        $this->app->singleton('codicastudio.health', $this->healthServiceClosure);

        $this->app->singleton(
            'codicastudio.health.commands',
            function () {
