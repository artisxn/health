...
return [
    ...
    */
    ...
    'database' => [
        ...
        'model' => codicastudio\Health\Data\Models\HealthCheck::class,
    ],
    ...
    'assets' => [
        'css' => base_path(
            'vendor/codicastudio/health/src/resources/dist/css/app.css'
        ),

        'js' => base_path(
            'vendor/codicastudio/health/src/resources/dist/js/app.js'
        ),
    ],

    'cache_files_base_path' => $path = 'app/codicastudio/health',
    ...
    'notifications' => [
        ...
        'notifier' => 'codicastudio\Health\Notifications\HealthStatus',
    ],
    ...
    'views' => [
        'panel' => 'codicastudio/health::default.panel',

        'empty-panel' => 'codicastudio/health::default.empty-panel',

        'partials' => [
            'well' => 'codicastudio/health::default.partials.well',
        ],
    ],
    ...
    'routes' => [
        ...
        'namespace' => $namespace = 'codicastudio\Health\Http\Controllers\Health',

        'notification' => 'codicastudio.health.panel',

        'list' => [
            [
                'uri' => "{$route_prefix}/panel",
                'name' => 'codicastudio.health.panel',
            ...
            [
                ...
                'name' => 'codicastudio.health.check',
            ...
            [
                ...
                'name' => 'codicastudio.health.string',
            ...
            [
                ...
                'name' => 'codicastudio.health.resources.all',
            ...
            [
                ...
                'name' => 'codicastudio.health.resources.get',
            ...
            [
                ...
                'name' => 'codicastudio.health.assets.css',
            ...
            [
                ...
                'name' => 'codicastudio.health.assets.js',
            ...
            [
                ...
                'name' => 'codicastudio.health.config',
